...
const TopPictures = () => {
    return (
        <div className="w-full flex flex-row-reverse bg-blue-900 px-8 sm:px-16 py-8 gap-6">
            <img src="./img/Black Friday.jpg" alt="black-friday" 
            className="w-full sm:w-6/12 h-80 sm:h-96 rounded-2xl cursor-pointer" />
            <div className="w-6/12 hidden sm:flex flex-col gap-8">
